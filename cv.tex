...
\begin{document}
    ...
    \begin{rSection}{In short}
        ...
        %
        On November 2022 I will start a PhD in Computer Science and Engineering.
    ...
    \begin{rSection}{Technical Strengths}
        \begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
            ...
            Programming Languages 	& Python, Java, Scala, C, C++, C\#, Prolog, R, Lua, JavaScript\\
            Data Analysis Tools		& R, Python + Pandas, NumPy, Scikitlearn, Keras, Weka \& Meka \\
