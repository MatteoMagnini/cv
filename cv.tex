...
\name{Matteo Magnini}
\website{\href{https://matteomagnini.github.io/}{matteomagnini.github.io}}
\birthday{June 19, 1995} 
\genre{Male}
\country{Luxembourg}
\town{4364, Esch-sur-Alzette}
\address{6 Av. de la Fonte}
\email{\href{mailto:matteo.magnini@uni.lu}{\texttt{matteo.magnini@uni.lu}}}
...
\begin{document}
    ...
    \begin{rSection}{In short}
        %
        PostDoctoral Researcher at the \href{https://www.uni.lu/fstm-en/}{Faculty of Science Technology and Medicine} (FSTM), \href{https://www.uni.lu/fstm-en/research-departments/department-of-computer-science/}{Department of Computer Science} (DCS), University of Luxembourg, Luxembourg.
        %
        Main research activities comprehends the fields of Artificial Intelligence (AI), Machine Learning, Logic and Neuro-Symbolic techniques.
        %
        Recently, my research has been focused on Large Language Models and Normative AI systems.
    \end{rSection}
    ...
    \begin{rSection}{Education and Carreer}
        ...
        \begin{rSubsection2}{Education}
            ...
            \item\textbf{Ph.D. degree}\hfill \textbf{Nov., 2022 $\rightarrow$ Oct., 2025}
            ...
            %
            \item\textbf{Ph.D. degree thesis}
            \\Symbolic Knowledge Injection \& Extraction for Autonomous Learning
            \\Relator: Prof. \href{mailto:andrea.omicini@unibo.it}{Andrea Omicini}
            \\Design and development of methods and tools for the symbolic extraction/injection from/into sub-symbolic predictors, including Large Language Models, and developing autonomous learning systems.
            \\External site: \url{github.com/MatteoMagnini/phd-thesis/releases/latest/download/phd-thesis.pdf}
            %
            ...
            %
            \item\textbf{ Master's degree thesis }
            ...
            \\External site: \url{amslaurea.unibo.it/23062}
            %
            ...
            \\110/110 \emph{cum laude}
            %
            \item\textbf{ Bachelor's degree thesis }
            ...
            \\External site: \url{amslaurea.unibo.it/17000}
            %
        ...
        \begin{rSubsection2}{Research Contracts}
            ...
            \item\textbf{Postdoctoral Researcher}\hfill \textbf{Dec., 2025 $\rightarrow$ Now}
    ...
    \begin{rSection}{Scientific Activities}
        ...
        \begin{rSubsection2}{Participation in Research Groups}
            ...
            \item\textbf{ PSLab Research group }\hfill \textbf{Oct., 2021 $\rightarrow$ Dec., 2025}
        ...
        \begin{rSubsection2}{Participation in Research Projects}
            ...
            \\Personalized Explainable Artificial Intelligence for decentralised agents with heterogeneous knowledge (EXPECTATION)
        ...
        \begin{rSubsection2}{International Experience}
            ...
            \item\textbf{ Visiting Ph.D. }\hfill \textbf{(3 Months) Mar., 2024 $\rightarrow$ Jun., 2024}
            ...
            \item\textbf{ Visiting Researcher }\hfill \textbf{(7 days) Apr., 2025}
            \\Department of Informatics, University of Oslo, Norway
            \\Paper writing and research activities.
            \\Contact: Prof. \href{mailto:anaoz@ifi.uio.no}{Ana Ozaki}

            \item\textbf{ Visiting Researcher }\hfill \textbf{(25 days) May., 2026 $\rightarrow$ Jun., 2026}
            \\Zhejiang University, Hangzhou, China
            \\Participation at the \href{https://www.zlaire.net/}{Zhejiang University – University of Luxembourg Joint Lab on Advanced Intelligent Systems and REasoning (ZLAIRE)} workshop, activities and research.
            \\Contact: Prof. \href{mailto:baiseliao@zju.edu.cn}{Beishui Liao}
        ...
        \begin{rSubsection2}{Organization of International Conferences}
            ...
            %
            \item \href{https://skilled-llms.github.io/2026/}{joint workshop on Statistics and Knowledge Integration for Logic, Learning, Ethical Decisions, and LLMs (SKILLED-LLMs 2026)} co-located with the FLoC 2026.
        ...
        \begin{rSubsection2}{Participation in Program Committees\\ of International Conferences}
            ...
            %
            \item \href{https://xaiworldconference.com/2026/}{The 4th World Conference on eXplainable Artificial Intelligence (XAI 2026)}
            %
            \item \href{https://www.discotec.org/2026/coordination}{28th International Conference on Coordination Models and Languages (COORDINATION 2026)}
            %
            \item \href{https://extraamas.ehealth.hevs.ch/index.html}{The 8th International Workshop on EXplainable and TRAnsparent AI and Multi-Agent Systems (EXTRAAMAS 2026)}
            %
        \end{rSubsection2}
        ...
        \begin{rSubsection2}{Editorial Activities}
            %
            \item\textbf{ Guest Editor }\hfill \textbf{2026 $\rightarrow$ Ongoing}
            \\Special Issue on \href{https://link.springer.com/collections/jcjdgeicdj}{``Engineering Foundation Models for Intelligent Robotic and Multi-Agent Systems''}
            \\in the \href{https://link.springer.com/journal/10791}{Discover Computing} Springer journal (ISSN: 2948-2992)
            %
        \end{rSubsection2}
        ...
        \begin{rSubsection2}{Reviewing for International Journals}
            ...
            %
            \item \href{https://peerj.com/computer-science/}{PeerJ Computer Science (ISSN: 2376-5992)}, 2025
            %
            \item \href{https://academic.oup.com/logcom}{Journal of Logic and Computation (ISSN: 1465-363X)}, 2026
            %
            \item \href{https://www.mdpi.com/journal/make}{Machine Learning and Knowledge Extraction (ISSN 2504-4990)}, 2026
            %
            \item \href{https://www.sciencedirect.com/journal/smart-health}{Smart Health (ISSN 2352-6491)}, 2026
        \end{rSubsection2}
        ...
        \begin{rSubsection2}{Other Talks}
            ...
            %
            \item Zhejiang University – University of Luxembourg Joint Lab on Advanced Intelligent Systems and REasoning (ZLAIRE 2026)
            \\\href{https://www.zlaire.net/}{The New Wave of Agentic AI: Main Challenges and Research Directions}
            %
            \item Joint Workshop on Statistics and Knowledge Integration for Logic, Learning, Ethical Decisions, and LLMs (SKILLED-LLMs 2026)
            \\\href{https://skilled-llms.github.io/2026/accepted/#:~:text=Systems%0AF.%20Sabbatini-,NL2UNIFOL,-%3A%20from%20Natural%20Language}{NL2UNIFOL: from Natural Language Sentences to Uniform First-Order Logic Formulae}
        \end{rSubsection2}
    ...
    \begin{rSection}{Teaching}
        ...
        %----------------------------------------------------------------------------------------
        %    COURSE RESPONSIBILITY SECTION
        %---------------------------------------------------------------------------------------

        \begin{rSubsection2}{Course Responsibility}
            \item\textbf{Selected Topics in Artificial Intelligence}\hfill \textbf{Sept., 2026 $\rightarrow$ Dec., 2026}
            \\Master in Information and Computer Science and Master in High Performance Computing, Esch-sur-Alzette, University of Luxembourg, Luxembourg
            \\Selected topics in Artificial Intelligence, including Generative AI, Deep Learning, Reinforcement Learning, and Neuro-Symbolic AI in a seminars format.
            \\textbf{Course Info:} \url{https://moodle.uni.lu/course/view.php?id=81}
        \end{rSubsection2}
        ...
        \begin{rSubsection2}{Tutoring}
            \item\textbf{Teaching assistant for the course ``Intelligent System 2'' }\hfill \textbf{Fed., 2026 $\rightarrow$ June, 2026}
            \\Bachelor in Computer Science (24 hours), University of Luxembourg, Luxembourg
            \\Knowledge of classical, modal and non-monotonic logics for knowledge representation and reasoning.
            \\Supervisor: Prof. \href{mailto:pere.pardo@uni.lu}{Pere Pardo Ventura}
            \\Course Info: \url{moodle.uni.lu/course/view.php?id=3918}
            %
            \item\textbf{Teaching assistant for the course ``Distributed Systems'' }\hfill \textbf{Sept., 2025 $\rightarrow$ Sept., 2026}
            \\Master in Computer Science and Engineering (24 hours), Cesena, University of Bologna, Italy
            ...
            \\Supervisor: Prof. \href{mailto:andrea.omicini@unibo.it}{Andrea Omicini}
            \\Course Info: \url{apice.unibo.it/xwiki/bin/view/Courses/Ds2526}
            %
            \item\textbf{ Teaching assistant for the course ``Fondamenti di Informatica'' }\hfill \textbf{Feb., 2025 $\rightarrow$ June, 2025}
            \\Bachelor in Electronic Engineering (35 hours), Cesena, University of Bologna, Italy
        ...
        \begin{rSubsection2}{Supervision of Graduate Students}
            ...
            %
            \item Nabila Waheed, Master's Degree
            \\\emph{\small{Department of Computer Science, Faculty of Science, Technology and Medicine, University of Luxembourg, Luxembourg}}
            \\Leveraging LLMs for Agent-Based Normative Recommender Systems, 2026.
    ...
    \begin{rSection}{Other Activities and Skills}
        ...
        \begin{rSubsection2}{Faculty Activity}
            ...
            \\Computer Science and Engineering, University of Bologna, Italy
            \\\url{corsi.unibo.it/magistrale/IngegneriaScienzeInformatiche/coordinatore-consiglio}
            %
            \item\textbf{ Master's Degree students Representative in AQ Council }\hfill \textbf{Jul., 2019 $\rightarrow$ Mar., 2021}
            \\Computer Science and Engineering, University of Bologna, Italy
            \\\url{corsi.unibo.it/magistrale/IngegneriaScienzeInformatiche/commissioni}
            %
        \end{rSubsection2}
        ...
        \begin{rSubsection2}{Lead Designer of Research-related Software}
            ...
            \\\url{github.com/psykei/psyke-python}
            %
            ...
            \\\url{github.com/psykei/psyki-python}
            %
            ...
            \\\url{github.com/MatteoMagnini/hyperTensionBot}
        \end{rSubsection2}
